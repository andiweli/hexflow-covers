...
**Note:**
At the moment there are only EU-covers available. You can file an issue for cover requests if you want.
As soon as there are enough covers for a solid basis, I will release the sources as .PSD file for Photoshop.
Have fun!
